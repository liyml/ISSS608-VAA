...
```{r}
con <- file("data/CoffeeChain.rds", "rb")
coffeechain <- readRDS(con)
close(con)
```
...
This section will focus on how to plot sparklines by using ggplot2.
...
This section will focus on  how to create static information dashboard by using [gt](https://gt.rstudio.com/) and [gtExtras](https://jthomasmock.github.io/gtExtras/index.html) packages.

### **31.5.1 Plotting a simple bullet chart**

This part will focus on how to prepare a bullet chart report by using functions of gt and gtExtras packages.
...
The below code chunk use to prepare the data for the sales report by product by using gtExtras functions.
...
This section will focus on how to create interactive information dashboard by using [reactable](https://glin.github.io/reactable/index.html) and [reactablefmtr](https://kcuilla.github.io/reactablefmtr/index.html) packages.
