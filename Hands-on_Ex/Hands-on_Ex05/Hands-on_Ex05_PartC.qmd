...
Recommend reading:  [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html)  for overall understanding of the features and functions of Heatmaply package.
