...
This Hands on Exercise will focusing on designing treemap using appropriate R packages. The hands on exercise consist of tree main section.

1.  How to manipulate transaction data into a treemap structure by using selected functions provided **dplyr** package
