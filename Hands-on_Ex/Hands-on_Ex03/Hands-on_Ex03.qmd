...
```{r}
pacman::p_load(ggigrah,plotly,patchwork,DT,tidyverse)
```
...
[ggiraph](https://davidgohel.github.io/ggiraph/index.html) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="57"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
