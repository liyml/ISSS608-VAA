...
This hands-on exercise will focus on how to create a proportional symbol map showing the number of wins by Singapore Pools’ outlets using an R package called **tmap**.
...
The below code chunk ensure that **tmap** package of R and other related R packages have been installed and loaded into R
...
The basic information of the newly created sgpools_sf is display using the code chunk below.
...
It is wiser to switch **tmap**’s Viewer back to plot mode by using the code chunk below.
