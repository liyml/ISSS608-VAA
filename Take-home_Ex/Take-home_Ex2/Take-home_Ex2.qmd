...
-   **tidyverse** – A collection of R packages designed for data manipulation, visualization, and analysis, including `ggplot2`, `dplyr`, `tidyr`, `readr`, etc.

<!-- -->

-   **ggthemes** – Provides additional themes, scales, and color palettes for `ggplot2`, useful for enhancing visual appeal.

<!-- -->

-   **scales** – Helps format numerical values in plots (e.g., percentages, currency, scientific notation).
...
-   **treemap** – Enables the creation of treemaps, which visualize hierarchical data using nested rectangles.

<!-- -->

-   **SmartEDA** – Automates exploratory data analysis (EDA), generating summary statistics, variable distributions, and correlation matrices.

<!-- -->

-   **forecast** – Provides tools for time-series forecasting, including ARIMA, ETS, and other forecasting models.
